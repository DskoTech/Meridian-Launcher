...
REM
REM Output: dist\Meridian NetBrowse\Meridian NetBrowse.exe
REM ================================================
...
if not exist "dist\Meridian NetBrowse\osk.bat" (
    copy /y "osk.bat" "dist\Meridian NetBrowse\osk.bat" >nul
)

if not exist "dist\Meridian NetBrowse\icon.ico" (
    copy /y "icon.ico" "dist\Meridian NetBrowse\icon.ico" >nul
)
...
echo   dist\Meridian NetBrowse\Meridian NetBrowse.exe
...
echo.
echo Run Meridian NetBrowse.exe from that folder (not by moving just the
echo .exe elsewhere) - it needs the rest of the files
echo PyInstaller placed alongside it. The Shell Handler is a standalone
echo single file and can be copied anywhere Meridian Launcher.exe is.
echo ================================================
pause
