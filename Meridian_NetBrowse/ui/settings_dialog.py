...
class SettingsDialog(QWidget):
    ...
    def __init__(
        ...
        # Meridian NetBrowse has no cyberpunk aesthetic GUI options (no
        # HUD/CRT/Scanlines/Glitch toggles) — those effects are always off
        # (see config.py DEFAULTS and main.py). Animation Level remains —
        # it's a general UI animation-speed setting, not a cyberpunk effect.
    ...
    def _save(self):
        ...
        visual_settings = {
            ...
            # Always off in Meridian NetBrowse — no UI to change them.
            "hud_enabled": False,
